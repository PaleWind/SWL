      ...
      <div className="min-w-full">
        ...
        <style
          dangerouslySetInnerHTML={{
            __html:
              "\n      .gradient {\n        background: linear-gradient(90deg, #f87171 0%, #daae51 100%);\n      }\n    ",
          }}
        />
          ...
          <div className="container mx-auto flex flex-wrap flex-col md:flex-row items-center">
            ...
            <div className="flex flex-col w-full md:w-2/5 items-center text-center md:text-left">
              ...
              <p className="flex justify-center leading-normal text-xl mb-8">
                With the all new "whatever-Im-Gonna-Call-It" light
              </p>
            ...
            <div className="flex justify-center w-full md:w-3/5 py-6 ">
              {/* <video
              muted
              src={"https://www.youtube.com/watch?v=NWVAufJtODM"}
              autoplay="true"
              loop="true"
            /> */}
              <iframe
            ...
            <div className="flex flex-col sm:flex-row justify-center pt-12 my-12 sm:my-4">
              ...
              <div className="flex flex-col w-5/6 lg:w-1/4 mx-auto lg:mx-0 rounded-none lg:rounded-l-lg bg-white mt-4">
                ...
                <div className="flex-none mt-auto bg-white rounded-b rounded-t-none overflow-hidden shadow p-6">
                  ...
                  <div className="flex items-center justify-center">
                    <button className="mx-auto bg-red-500 lg:mx-0 hover:underline gradient text-white font-bold rounded-full my-6 py-4 px-8 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out">
                      Sign Up
                    </button>
                  </div>
                </div>
